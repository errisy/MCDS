Public Class MultipleWordBox
    Inherits Control
    Implements IMouseInputProvider


#Region "RoutedEvents"
    'MultipleWordBox -> AddingViewForItem As ItemViewEventHandler
    ...
    Public Shared ReadOnly AddingViewForItemEvent As RoutedEvent = _
                  ...
                  GetType(ItemViewEventHandler), GetType(MultipleWordBox))

#End Region
#Region "Dependency Properties"


    'MultipleWordBox->ItemTemplate As DataTemplate Default: Nothing
    ...
    Public Shared ReadOnly ItemTemplateProperty As DependencyProperty = _
                           ...
                           GetType(DataTemplate), GetType(MultipleWordBox), _
    ...
    Private Shared Sub SharedItemTemplateChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        DirectCast(d, MultipleWordBox).ItemTemplateChanged(d, e)
    End Sub
    Private Sub ItemTemplateChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        BuildViews()
    End Sub

    'MultipleWordBox->ItemTemplateSelector As DirectDataTemplateSelector Default: Nothing
    ...
    Public Shared ReadOnly ItemTemplateSelectorProperty As DependencyProperty = _
                           ...
                           GetType(DirectDataTemplateSelector), GetType(MultipleWordBox), _
    ...
    Private Shared Sub SharedItemTemplateSelectorChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        DirectCast(d, MultipleWordBox).ItemTemplateSelectorChanged(d, e)
    End Sub
    Private Sub ItemTemplateSelectorChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        BuildViews()
    End Sub

    'MultipleWordBox->ItemsPanel As DataTemplate Default: Nothing
    ...
    Private Shared Sub SharedItemsPanelChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        DirectCast(d, MultipleWordBox).ItemsPanelChanged(d, e)
    End Sub
    Private Sub ItemsPanelChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        BuildPanel()
    End Sub

    'MultipleWordBox->ItemsSource As IEnumerable Default: Nothing
    ...
    Public Shared ReadOnly ItemsSourceProperty As DependencyProperty = _
                           ...
                           GetType(IEnumerable), GetType(MultipleWordBox), _
    ...
    Private Shared Sub SharedItemsSourceChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        DirectCast(d, MultipleWordBox).ItemsSourceChanged(d, e)
    End Sub
    ...
    Public Shared ReadOnly IsReadOnlyProperty As DependencyProperty = _
                           ...
                           GetType(Boolean), GetType(MultipleWordBox), _
    ...
    Private Shared Sub SharedIsReadOnlyChanged(d As DependencyObject, e As DependencyPropertyChangedEventArgs)
        DirectCast(d, MultipleWordBox).IsReadOnlyChanged(d, e)
    End Sub
...
#End Region
    ...
    Protected Sub PerformMouseDoubleDown(e As MouseButtonEventArgs)
        ...
        [RaiseEvent](mbe)
    End Sub
    'MultipleWordBox -> MouseWheelZoom As MouseEventHandler
    ...
    Public Shared ReadOnly ProvideMouseWheelEvent As RoutedEvent = _
                  ...
                  GetType(MouseWheelEventHandler), GetType(MultipleWordBox))
    'MultipleWordBox -> ProvideMouseDown As MouseButtonEventHandler
    ...
    Public Shared ReadOnly ProvideMouseDownEvent As RoutedEvent = _
                  ...
                  RoutingStrategy.Direct, _
                  GetType(MouseButtonEventHandler), GetType(MultipleWordBox))
    'MultipleWordBox -> ProvideMouseMove As MouseEventHandler
    ...
    Public Shared ReadOnly ProvideMouseMoveEvent As RoutedEvent = _
                  ...
                  RoutingStrategy.Direct, _
                  GetType(MouseEventHandler), GetType(MultipleWordBox))
    'MultipleWordBox -> ProvideMouseUp As MouseButtonEventHandler
    ...
    Public Shared ReadOnly ProvideMouseUpEvent As RoutedEvent = _
                  ...
                  RoutingStrategy.Direct, _
                  GetType(MouseButtonEventHandler), GetType(MultipleWordBox))
    'MultipleWordBox -> ProvideMouseDoubleDown As MouseButtonEventHandler
    ...
    Shared Sub New()
        Control.BackgroundProperty.OverrideMetadata(GetType(MultipleWordBox), New FrameworkPropertyMetadata(Brushes.White, FrameworkPropertyMetadataOptions.AffectsRender))
    End Sub
End Class
